...
import com.example.recyclerviewexampleapp.R;

public class ProviderLocalTest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_provider_local_test);
